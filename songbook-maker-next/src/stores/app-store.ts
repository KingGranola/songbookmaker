      ...
      (set, get) => ({
        ...
        toggleEditMode: () =>
          set((store) => ({
            state: {
              ...
              isEraserMode: store.state.isEditMode ? store.state.isEraserMode : false
            }
          })),
        ...
        toggleEraserMode: () =>
          set((store) => ({
            state: {
              ...store.state,
              isEraserMode: !store.state.isEraserMode,
              isEditMode: store.state.isEraserMode ? store.state.isEditMode : false
            }
          })),
...
export const useAppActions = () => {
  ...
  return {
    ...
    toggleEraserMode: store.toggleEraserMode,
